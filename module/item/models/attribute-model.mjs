...
export class AttributeDataModel extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      ...
      value: new fields.NumberField({ required: true, initial: 2, min: 0, max: 5, integer: true }),
      // Valeur courante — réduite si variante attribute damage
      current: new fields.NumberField({ required: true, initial: 2, min: 0, max: 5, integer: true }),
