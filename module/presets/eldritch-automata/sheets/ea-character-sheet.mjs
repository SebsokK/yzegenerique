...
export class EaCharacterSheet extends YZESheetMixin(
  ...
  async _prepareContext(options) {
    ...
    context.enriched.breakdownText = await TextEditor.enrichHTML(this.actor._source?.system?.breakdownText || '', { async: true });
    context.enriched.berserkText = await TextEditor.enrichHTML(this.actor._source?.system?.berserkText || '', { async: true });
    return context;
  }
