...
export const SleepyHollowPreset = {
  ...
  // Boutons rapides pour la Free Attack (attrSlug + skillSlug)
  quickAttacks: [
    { id: "melee",  label: "Melee",  attrSlug: "strength", skillSlug: "melee"         },
    { id: "ranged", label: "Ranged", attrSlug: "agility",  skillSlug: "marksmanship"  },
  ],

  // Couleurs DSN par défaut pour ce preset
  dsnColors: {
    stressFg: "#1a1208", stressBg: "#c9a84c",   // jaune
    gearFg:   "#f0ead6", gearBg:   "#5c3d2e",   // marron ivoire
  },
  dsnLabels: {
    bane: "☠", success: "✦", stressBane: "⚡",
  },
  titleFont: "Grenze Gotisch",
  themeColors: { accent: "#c9a84c", bg: "#1a1208" },
